...
mat_list= openmc.Materials([Breeder_material, Shielding_material, Steel_material])
...
dag_univ = openmc.DAGMCUniverse('/Users/rocco698/Desktop/Undergrad/Spring_2026/NUCE_431W/NUCE_431W/OpenMC_STAR_Model/Rocco_testing/Breeder_scaled.h5m', auto_geom_ids = True)

root_cell = openmc.Cell(fill = dag_univ)

root_cell.region = -openmc.Sphere(r = 2000.0, boundary_type = 'vacuum')
