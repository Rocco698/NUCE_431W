...
\hline
  &  DAGMC design\\
Vassil Ivakimov &  OpenMC design\\
  &  Assorted CAD tasks\\
\hline
 &  OpenMC source development\\
...
Going forward, the largest change in the group's WBS will be the addition of anything Cubit or CAD, which will be handled by Sean Dailey. 
...
After the mid-semester break, we will be running sims with the goal of validating our model as soon as the particle leakage issue is fixed.
...
If publication of this project were to occur, the publication work would almost certainly continue after the end of the semester and the graduation of the group members. The decision to continue this project beyond the bounds of the Nuce 431W will be made after enough simulations are run and data has been processed later in March or early mid-April.
