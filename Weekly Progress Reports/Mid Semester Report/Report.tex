...
\cite{Khodak2025}. 
However, there is a huge problem with these 14 MeV neutrons from the D-T reaction. Mainly, their high energy and therefore the incredible harm the neutrons can cause to both electronics and people outside of the reactor. That is why a shield is incredibly necessary. Now, there is a huge constraints with the shielding that makes it difficult, there is very limited volume that the shield can occupy. This is problematic since neutrons will always have some fraction of the total that is able to pass through any volume, especially a small one. Therefore the shield needs to not only have a large cross-section of interaction with these 14 MeV neutrons, but that reaction must also not cause significant resulting reactions that could cause harm themselves. The shield should also be designed in such a way that both cost and maintenance isn't hindered. (ie it probably shouldn't be a liquid)
